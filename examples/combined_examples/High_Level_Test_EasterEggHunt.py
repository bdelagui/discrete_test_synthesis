...
sys.path.append('...') # enable importing modules from an upper directory:
from classes.gridworld_class import GridWorld as gc
from classes import Player_class as pc
from classes.Game_graph_class import Game_Graph as gg
from classes.General_Game_Graph_class import GeneralGameGraph as ggg
from classes.test_run_configuration import test_run_configuration as trc
