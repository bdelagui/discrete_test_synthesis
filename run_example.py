from examples.combined_examples import Easter_Egg_Hunt
#from examples.dynamic_examples import dyn_example1, dyn_example2
#from examples.static_examples import Illustrate
